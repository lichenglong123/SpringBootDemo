...
public class RedisUtil {
     ...
     * redis锁前缀
     */
    public static String LOCK_PREFIX = "account_lock_";
                ...
                if (acquire) {
                    ...
                    if (Objects.nonNull(value) && value.length > 0) {
                        ...
                        if (expireTime < System.currentTimeMillis()) {
                            // 如果锁已经过期
                            byte[] oldValue = redisConnection.getSet(lock.getBytes(), String.valueOf(System.currentTimeMillis() + DEFAULT_EXPIRE + 1).getBytes());
                            // 防止死锁
